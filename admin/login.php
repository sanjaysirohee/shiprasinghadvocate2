...
<head>
    ...
    <title>Shiprasinghadvocate Admin Login</title>
...
<body class="skin-default card-no-border">
	...
	<form class="form-horizontal form-material" id="loginform" action="<?php echo BASE_URL ?>shiprashinghadvocate2/admin/controller/auth.php" method="post">
					<?php }else{ ?>
